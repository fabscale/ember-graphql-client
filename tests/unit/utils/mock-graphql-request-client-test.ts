...
import { mockGraphQLError } from 'ember-graphql-client/utils/mock-graphql-error';
import { getMockGraphQLRequestClient } from 'ember-graphql-client/utils/mock-graphql-request-client';
import { setupTest } from 'ember-qunit';
import { TestContext } from 'ember-test-helpers';
import { module, test } from 'qunit';

module('Unit | Utilities | mock-graphql-request-client', function (hooks) {
  setupTest(hooks);

  hooks.beforeEach(function () {
    assert(
      'MOCK_GRAPHQL environment variable is not set, which will lead to failed tests.',
